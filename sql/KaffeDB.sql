...
CREATE TABLE BrentKaffe (
	...
	CONSTRAINT BrentKaffe_FK1 FOREIGN KEY (BrenneriID) REFERENCES Brenneri(BrenneriID)
		ON UPDATE CASCADE
		ON DELETE SET DEFAULT,
	CONSTRAINT BrentKaffe_FK2 FOREIGN KEY (PartiID) REFERENCES KaffeParti(PartiID)
		ON UPDATE CASCADE
		ON DELETE SET DEFAULT);
...
CREATE TABLE Parti (
	...
	CONSTRAINT KaffeParti_FK1 FOREIGN KEY (GardID) REFERENCES Gard(GardID)
		ON UPDATE CASCADE
		ON DELETE SET DEFAULT,
	CONSTRAINT KaffeParti_FK2 FOREIGN KEY (ForedlingNavn) REFERENCES Foredlingsmetode(Navn)
		ON UPDATE CASCADE
		ON DELETE SET DEFAULT);
